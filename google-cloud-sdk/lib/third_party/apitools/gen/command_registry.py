...
class CommandRegistry(object):
    ...
    def AddCommandForMethod(self, service_name, method_name, method_info,
        ...
        if method_info.upload_config:
            # TODO(user): Consider adding additional flags to allow
    ...
    def __FlagInfoFromField(self, extended_field, extended_message, fv=''):
        ...
        # TODO(user): We should key by variant.
        ...
        if flag_info.type == 'enum':
            # TODO(user): Does protorpc do this for us?
    ...
    def __PrintFlag(self, printer, flag_info):
        ...
        with printer.Indent(indent='    '):
            ...
            # TODO(user): Consider using 'drop_whitespace' elsewhere.
    ...
    def WriteFile(self, printer):
        ...
        printer('# NOTE: This file is autogenerated and should not be edited '
                'by hand.')
        # TODO(user): Add a build stamp, along with some other
        # information.
        printer()
        printer('import code')
        printer('import os')
        ...
        with printer.Indent():
            ...
            # TODO(user): Just call SetDefaultCommand as soon as

...
class EnableEnforce(base.Command):
  """Turns on enforcement of boolean OrgPolicy constraint.

  Turns on enforcement of a boolean OrgPolicy constraint at the specified
  resource.

  ## EXAMPLES

  The following command enables enforcement of the OrgPolicy boolean constraint
  `compute.disableSerialPortAccess` on project `foo-project`:
